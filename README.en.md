...
Plate Stabilize Crop removes the selected motion while keeping the requested output dimensions. Generated Crop Matchmove applies the inverse mapping to return that crop to the plate.
